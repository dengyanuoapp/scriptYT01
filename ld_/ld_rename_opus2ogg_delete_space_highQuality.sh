...
then
    ...
    if [ -f "${bb4}" ] ; then
        ...
        if [ -z "${ppW}" -o -z "${ppH}" ] ; then
            ...
            #echo   "nice -n 19 ffmpeg -i \"${bb1}\" -vcodec libx265 -r 12 -vf scale=\"${pp5}\" -acodec libopus -ac 1 -maxrate ${rate} -ar ${freq} -ab ${rate} -y \"${bb4}\""
            #        nice -n 19 ffmpeg -i  "${bb1}"  -vcodec libx265 -r 12 -vf  scale="${pp5}"  -acodec libopus -ac 1 -maxrate ${rate} -ar ${freq} -ab ${rate} -y  "${bb4}"
            #echo   "nice -n 19 ffmpeg -i \"${bb1}\" -vcodec libx265 -acodec libopus -ac 1 -maxrate ${rate} -ar ${freq} -ab ${rate} -y \"${bb4}\""
            #        nice -n 19 ffmpeg -i  "${bb1}"  -vcodec libx265 -acodec libopus -ac 1 -maxrate ${rate} -ar ${freq} -ab ${rate} -y  "${bb4}"
            echo   "nice -n 19 ffmpeg -i \"${bb1}\" -vcodec libx265 -vf scale=\"${pp4}\" -acodec libopus -ac 1 -maxrate ${rate} -ar ${freq} -ab ${rate} -y \"${bb4}\""
                    nice -n 19 ffmpeg -i  "${bb1}"  -vcodec libx265 -vf  scale="${pp4}"  -acodec libopus -ac 1 -maxrate ${rate} -ar ${freq} -ab ${rate} -y  "${bb4}"
