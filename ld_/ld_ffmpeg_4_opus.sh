...
echo   "LD_LIBRARY_PATH=${rr2} nice -n 19 ffmpeg -vn -i ${1} -ac 1 -maxrate ${rate} -ar ${freq} -f opus -ab ${rate} -y ${date1}_${bb2}.ogg"
        LD_LIBRARY_PATH=${rr2} nice -n 19 ffmpeg -vn -i ${1} -ac 1 -maxrate ${rate} -ar ${freq} -f opus -ab ${rate} -y ${date1}_${bb2}.ogg
